...
YaMusicTG является проприетарным программным обеспечением, распространяемым по **PROPRIETARY NON-COMMERCIAL LICENSE**.

Запрещается использовать, копировать, изменять, создавать ответвления, публиковать, распространять, воспроизводить или иным образом использовать исходный код или программное обеспечение без предварительного письменного разрешения автора.

См. [`LICENSE`](LICENSE) файл с полными условиями лицензии.
